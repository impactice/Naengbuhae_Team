    ...
    return (
      <div className="min-h-screen bg-background flex justify-center items-center px-4">
        <div className="w-full max-w-md bg-background text-foreground rounded-2xl shadow-xl p-8 text-center">
          ...
          <p className="text-sm text-muted-foreground mb-6">다음 로그인부터 새 비밀번호로 입장해주세요.</p>
          <button
      ...
      <div className="w-full max-w-md bg-background text-foreground min-h-screen shadow-xl">
        ...
        <form onSubmit={handleSubmit} className="px-5 py-6 space-y-4">
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-3 bg-card border border-border rounded-xl focus:outline-none focus:ring-2 focus:ring-accent pr-12"
                required
              />
              <button
                type="button"
          ...
          <button
            type="submit"
            disabled={submitting}
            className="w-full py-4 bg-foreground text-background rounded-xl disabled:opacity-50"
            style={{ fontWeight: 600 }}
          >
